//Source: https://github.com/spacehuhn/esp8266_beaconSpam/blob/master/esp8266_beaconSpam/esp8266_beaconSpam.ino
...
const char ssids[] PROGMEM = {
  ...
  "Hamster Combat Fan\n"
  "Горяие шлюшки\n"
  "Порридж Сити - все сосите\n"
  "Спальная комната твоя мама\n"
  "Мартышкина радость\n"
  "Твоя мамка Online\n"
  "Гей-клуб Уголок\n"
  "Твоя бабушка тут\n"
  ...
  "ПорноХаб с лагами\n"
  "Великая дыра\n"
  "Павильон для идиотов\n"
  "Мамкин стриптизер\n"
  "Спермомет 3000\n"
  "Винишко и слезы\n"
  "Твой сосед Шизофреник\n"
  "Мамин водопроводчик\n"
  "Гейская пародия\n"
  "Грязные трусики\n"
  "Папкин подвальчик\n"
  "Твою маму видели тут\n"
  "Ты педофил\n"
  "Loading…\n"
  "Свинарник Сити\n"
  "VIRUS.EXE\n"
  ...
  "Шлюхопровод\n"
  "Пьяные трактористы\n"
  "Надежда 500 м от Вас...\n"
  "Капкан для свиней\n"
  "Топкая говнища\n"
  "1 в кепке др.тож пизды получит\n"
  "Кровавая трясинаn"
};
// ==================== //
...
void spamSettingSchouldBeInSetup(){
  // create empty SSID
  for (int i = 0; i < 32; i++)
    emptySSID[i] = ' ';
